...
int main(void)
{
    ...
    RL_Path *path = rl_path_create(map, start, end, rl_graph_score_manhattan, rl_graph_neighbors_cardinal);
    ...
    path = rl_path_create(map, start, end, rl_graph_score_euclidian, rl_graph_neighbors_ordinal);
    while ((path = rl_path_walk(path))) {
